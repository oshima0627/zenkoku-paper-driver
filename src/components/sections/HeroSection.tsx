...
export default function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-[#f5f5f7] via-white to-[#e8f0fe]">
      {/* Subtle gradient orbs */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-15%] right-[-5%] w-[500px] h-[500px] bg-blue-200/30 rounded-full blur-[100px]" />
        <div className="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-cyan-200/20 rounded-full blur-[100px]" />
        <div className="absolute top-[40%] left-[30%] w-[300px] h-[300px] bg-blue-100/25 rounded-full blur-[80px]" />
      </div>
      ...
      <div className="relative max-w-5xl mx-auto px-6 py-20 text-center">
        ...
        >
          <motion.p
            ...
            className="text-sm font-medium tracking-[0.2em] text-[var(--color-text-light)] uppercase mb-6"
          >
