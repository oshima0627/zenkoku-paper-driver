      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-4 text-base sm:text-lg text-[var(--color-text-light)] leading-relaxed">
            <span className="hidden sm:inline">AI業務自動化・HP制作と安全運転講習の2つの事業を柱に、<br />企業の課題解決に取り組みます。</span>
            <span className="sm:hidden">AI業務自動化・HP制作と<br />安全運転講習の2つの事業を柱に、<br />企業の課題解決に取り組みます。</span>
          </p>
        </motion.div>
