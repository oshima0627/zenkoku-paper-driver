...
const services = [
  ...
  {
    title: "関西エリア対応",
    description: "御社の所在地や社員様のご自宅付近まで講師が出張いたします。現在は関西地区を中心に対応しており、順次全国展開予定です。",
    ...
    <>
      ...
      <section className="py-28 md:py-36">
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-blue-50 text-blue-600 text-xs font-semibold mb-4">安全運転講習事業</span>
      ...
      {/* Flow */}
      <section id="driving-flow" className="py-28 md:py-36">
