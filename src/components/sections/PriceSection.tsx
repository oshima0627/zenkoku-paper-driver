    ...
    >
      ...
      <div className="px-6 py-5 flex items-start justify-between gap-4">
        ...
        <div className="text-right shrink-0">
          <p className="text-2xl font-bold text-indigo-600 leading-tight">{price}</p>
              ...
              {techPlan.map((row, i) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    {row.popular === 1 && (
                      <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white">人気No.1</span>
                    )}
                    {row.popular === 2 && (
            ...
            >
              ...
              <div className="divide-y divide-gray-100">
                <div className="flex justify-between items-center px-6 py-3.5">
                  ...
                  <span className="text-sm font-semibold text-indigo-600">1人 ¥5,000</span>
                </div>
                <div className="flex justify-between items-center px-6 py-3.5">
                  <span className="text-sm text-gray-500">教習報告書作成</span>
                  <span className="text-sm font-semibold text-indigo-600">1回 ¥3,000</span>
                </div>
              </div>
              <div className="px-6 py-3 border-t border-gray-100 bg-gray-50">
